...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c13 = function(prefix, fieldname, range) {
      ...
      peg$c14 = function(prefix, fieldname, node) {
      ...
      peg$c15 = function(prefix, fieldname, term) {
            let fieldexp = {
      ...
      peg$c21 = function(prefix, term, similarity, boost) {
            return {
              similarity,
              boost,
              prefix,
      ...
      peg$c64 = function(rangeOpen, termMin, termMax, rangeClose) {
            return {
              term_min: termMin.value,
              term_min_location: termMin.location,
              term_max: termMax.value,
              term_max_location: termMax.location,
              min_inclusive: rangeOpen === '[',
              max_inclusive: rangeClose === ']'
            };
          },
